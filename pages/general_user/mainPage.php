        ...
        <div class="container-fluid main-body">
            ...
            <div class="row mbody">
                <div class="col-lg-6 col-md-12 col-sm-12 col-one">
                    ...
                    <p class="onep">In this project, we are developing a System based on the services that UIU provides
                        for the students. It will reduce the problem to get these services that our university provides
                        by combining them in a single platform. The services include Hostel Service, Suttle Service
                        Registration, Student Loans, Club Forum Discussion, and Posts.</p>
                    <button onclick="location.href='post.php';" class="btn btn-warning cus-b3">Get Started</button>
                </div>
