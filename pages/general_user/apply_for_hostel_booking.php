    ...
    <div class="container">
        <h2>Available Hostel Rooms</h2>
         ...
         <?php
                                 ...
                                 $r = "SELECT * FROM `hostel_rooms` where type = 'single'";
                                 ...
                                 <?php $r = "SELECT * FROM `hostel_rooms` where type = 'single'";
                                 $result = mysqli_query($sql, $r);
                                 if (mysqli_num_rows($result) > 0) {
                                     while ($post_row = mysqli_fetch_assoc($result)){?>
        <div class="room-card" >
            <img class="room-image" src="<?php echo $image; ?>">
            <h3 class="room-title"><?php echo $type; ?> Bed Room</h3>
            <p class="room-price"><?php echo $price; ?>tk per motnth</p>
 ...
 <div class="container">
        <h2>Available Hostel Rooms</h2>
         ...
         <?php
                                 ...
                                 $r = "SELECT * FROM `hostel_rooms` where type = 'double'";
                                 $result = mysqli_query($sql, $r);
                                 if (mysqli_num_rows($result) > 0) {
                                     while ($post_row = mysqli_fetch_assoc($result)) {
                                 ...
                                 <?php $r = "SELECT * FROM `hostel_rooms` where type = 'double'";
                                 $result = mysqli_query($sql, $r);
                                 if (mysqli_num_rows($result) > 0) {
                                     while ($post_row = mysqli_fetch_assoc($result)){?>
        <div class="room-card" >
